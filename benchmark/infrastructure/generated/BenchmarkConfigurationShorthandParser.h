...
public:
  ...
  BenchmarkConfigurationShorthandParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);
  ...
  public:
    ShortHandStringContext(antlr4::ParserRuleContext *parent, size_t invokingState);
  ...
  public:
    BenchmarkConfigurationShorthandParser::AssignmentContext *assignmentContext = nullptr;
  ...
  public:
    BenchmarkConfigurationShorthandParser::ContentContext *contentContext = nullptr;
