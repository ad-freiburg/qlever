...
std::any BenchmarkConfigurationShorthandParser::ShortHandStringContext::accept(
    tree::ParseTreeVisitor* visitor) {
  if (auto parserVisitor =
          dynamic_cast<BenchmarkConfigurationShorthandVisitor*>(visitor))
...
std::any BenchmarkConfigurationShorthandParser::AssignmentsContext::accept(
    tree::ParseTreeVisitor* visitor) {
  if (auto parserVisitor =
          dynamic_cast<BenchmarkConfigurationShorthandVisitor*>(visitor))
...
std::any BenchmarkConfigurationShorthandParser::AssignmentContext::accept(
    tree::ParseTreeVisitor* visitor) {
  if (auto parserVisitor =
          dynamic_cast<BenchmarkConfigurationShorthandVisitor*>(visitor))
...
std::any BenchmarkConfigurationShorthandParser::ObjectContext::accept(
    tree::ParseTreeVisitor* visitor) {
  if (auto parserVisitor =
          dynamic_cast<BenchmarkConfigurationShorthandVisitor*>(visitor))
...
std::any BenchmarkConfigurationShorthandParser::ListContext::accept(
    tree::ParseTreeVisitor* visitor) {
  if (auto parserVisitor =
          dynamic_cast<BenchmarkConfigurationShorthandVisitor*>(visitor))
...
std::any BenchmarkConfigurationShorthandParser::ContentContext::accept(
    tree::ParseTreeVisitor* visitor) {
  if (auto parserVisitor =
          dynamic_cast<BenchmarkConfigurationShorthandVisitor*>(visitor))
