...
int main(int argc, char** argv) {
  ...
  RuntimeParameters().set<StripColumnsParameter>(true);
  ...
  add("cache-max-size,c", optionFactory.getProgramOption<CacheMaxSize>(),
  ...
  add("cache-max-size-single-entry,e",
      optionFactory.getProgramOption<CacheMaxSizeSingleEntry>(),
  ...
  add("cache-max-size-lazy-result,E",
      optionFactory.getProgramOption<CacheMaxSizeLazyResult>(),
  ...
  add("cache-max-num-entries,k",
      optionFactory.getProgramOption<CacheMaxNumEntries>(),
  ...
  add("default-query-timeout,s",
      optionFactory.getProgramOption<DefaultQueryTimeout>(),
      "Set the default timeout in seconds after which queries are cancelled"
      "automatically.");
  add("service-max-value-rows,S",
      optionFactory.getProgramOption<ServiceMaxValueRows>(),
  ...
  add("throw-on-unbound-variables",
      optionFactory.getProgramOption<ThrowOnUnboundVariables>(),
  ...
  add("request-body-limit", optionFactory.getProgramOption<RequestBodyLimit>(),
      "Set the maximum size for the body of requests the server will process. "
      "Set to zero to disable the limit.");
  add("cache-service-results",
      optionFactory.getProgramOption<CacheServiceResults>(),
  ...
  add("syntax-test-mode", optionFactory.getProgramOption<SyntaxTestMode>(),
  ...
  add("enable-prefilter-on-index-scans",
      optionFactory.getProgramOption<EnablePrefilterOnIndexScans>(),
      "If set to false, the prefilter procedures for FILTER expressions are "
      "disabled.");
  add("spatial-join-max-num-threads",
      optionFactory.getProgramOption<SpatialJoinMaxNumThreads>(),
  ...
  add("spatial-join-prefilter-max-size",
      optionFactory.getProgramOption<SpatialJoinPrefilterMaxSize>(),
