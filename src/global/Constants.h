...
constexpr inline std::string_view hasQgram{"has-qgram"};
}  // namespace constants::details::strings
constexpr inline std::string_view LANGUAGE_PREDICATE =
    makeQleverInternalIriConst<constants::details::strings::langtag>();
constexpr inline std::string_view HAS_QGRAM_PREDICATE =
    makeQleverInternalIriConst<constants::details::strings::hasQgram>();
