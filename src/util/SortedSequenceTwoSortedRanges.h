...
#ifndef QLEVER_SRC_UTIL_SORTEDSEQUENCETWOSORTEDRANGES_H
#define QLEVER_SRC_UTIL_SORTEDSEQUENCETWOSORTEDRANGES_H
...
// Implementation of `SortedSequence` (see `util/SortedSequence.h`) that is
// optimized for sorted access. Elements are stored in a vector
...
class SortedSequenceTwoSortedRanges {
  ...
  FRIEND_TEST(SortedSequenceTwoSortedRangesTest, eraseSortedSubRange);
  FRIEND_TEST(SortedSequenceTwoSortedRangesTest, sortAndRemoveDuplicates);
  FRIEND_TEST(SortedSequenceTwoSortedRangesTest, constructor);
  FRIEND_TEST(SortedSequenceTwoSortedRangesTest, insert);
  friend struct SortedSequenceTwoSortedRangesPairsTestHelper;

 public:
  SortedSequenceTwoSortedRanges() = default;

  // Create a `SortedSequence` from already sorted and deduplicated elements.
  static SortedSequenceTwoSortedRanges fromSorted(
    ...
    AD_EXPENSIVE_CHECK(ql::ranges::adjacent_find(sortedElements, {}, proj) ==
                       sortedElements.end());
    SortedSequenceTwoSortedRanges seq;
 ...
 public:
  ...
  friend std::ostream& operator<<(std::ostream& os,
                                  const SortedSequenceTwoSortedRanges& sv) {
    os << "{ ";
...
#endif  // QLEVER_SRC_UTIL_SORTEDSEQUENCETWOSORTEDRANGES_H
