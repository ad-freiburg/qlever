...
//! those escape sequences that are used by the old broccoli middle-end.
//! Extend this method before using it for general purpose decoding
//! alter this comment!
inline string urlDecode(const string& orig);
