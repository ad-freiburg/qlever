...
CPP_template(typename Executor, typename Function,
             typename Handler) (requires ql::concepts::invocable<Function>)
...
CPP_template(
    ...
    typename Handler) (requires ql::concepts::invocable<std::decay_t<Function>>)
...
CPP_template(
    ...
    typename Function) (requires ql::concepts::invocable<Function> CPP_and(
