...
struct MemorySizeLanguageParserStaticData final {
  ...
  MemorySizeLanguageParserStaticData(const MemorySizeLanguageParserStaticData&) = delete;
  MemorySizeLanguageParserStaticData(MemorySizeLanguageParserStaticData&&) = delete;
  MemorySizeLanguageParserStaticData& operator=(const MemorySizeLanguageParserStaticData&) = delete;
  MemorySizeLanguageParserStaticData& operator=(MemorySizeLanguageParserStaticData&&) = delete;
...
static thread_local
#endif
MemorySizeLanguageParserStaticData *memorysizelanguageParserStaticData = nullptr;
...
void memorysizelanguageParserInitialize() {
  ...
  auto staticData = std::make_unique<MemorySizeLanguageParserStaticData>(
    std::vector<std::string>{
      "memorySizeString", "pureByteSize", "memoryUnitSize"
    },
    std::vector<std::string>{
      "", "'B'"
    },
    std::vector<std::string>{
      "", "", "MEMORY_UNIT", "UNSIGNED_INTEGER", "FLOAT", "WHITESPACE"
    }
  );
  static const int32_t serializedATNSegment[] = {
  	...
  	0,0,10,11,5,0,0,1,11,1,1,0,0,0,12,13,5,3,0,0,13,14,5,1,0,0,14,3,1,0,0,
  	0,15,16,7,0,0,0,16,17,5,2,0,0,17,5,1,0,0,0,1,8
  };
...
MemorySizeLanguageParser::MemorySizeLanguageParser(TokenStream *input) : MemorySizeLanguageParser(input, antlr4::atn::ParserATNSimulatorOptions()) {}

MemorySizeLanguageParser::MemorySizeLanguageParser(TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options) : Parser(input) {
  MemorySizeLanguageParser::initialize();
  _interpreter = new atn::ParserATNSimulator(this, *memorysizelanguageParserStaticData->atn, memorysizelanguageParserStaticData->decisionToDFA, memorysizelanguageParserStaticData->sharedContextCache, options);
}
...
antlr4::atn::SerializedATNView MemorySizeLanguageParser::getSerializedATN() const {
...
MemorySizeLanguageParser::MemorySizeStringContext::MemorySizeStringContext(ParserRuleContext *parent, size_t invokingState)
...
MemorySizeLanguageParser::PureByteSizeContext* MemorySizeLanguageParser::MemorySizeStringContext::pureByteSize() {
  return getRuleContext<MemorySizeLanguageParser::PureByteSizeContext>(0);
}

MemorySizeLanguageParser::MemoryUnitSizeContext* MemorySizeLanguageParser::MemorySizeStringContext::memoryUnitSize() {
...
MemorySizeLanguageParser::MemorySizeStringContext* MemorySizeLanguageParser::memorySizeString() {
  MemorySizeStringContext *_localctx = _tracker.createInstance<MemorySizeStringContext>(_ctx, getState());
...
MemorySizeLanguageParser::PureByteSizeContext::PureByteSizeContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tree::TerminalNode* MemorySizeLanguageParser::PureByteSizeContext::UNSIGNED_INTEGER() {
...
MemorySizeLanguageParser::PureByteSizeContext* MemorySizeLanguageParser::pureByteSize() {
  PureByteSizeContext *_localctx = _tracker.createInstance<PureByteSizeContext>(_ctx, getState());
  ...
  try {
    ...
    setState(13);
    match(MemorySizeLanguageParser::T__0);
...
MemorySizeLanguageParser::MemoryUnitSizeContext::MemoryUnitSizeContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tree::TerminalNode* MemorySizeLanguageParser::MemoryUnitSizeContext::MEMORY_UNIT() {
  return getToken(MemorySizeLanguageParser::MEMORY_UNIT, 0);
}

tree::TerminalNode* MemorySizeLanguageParser::MemoryUnitSizeContext::UNSIGNED_INTEGER() {
  return getToken(MemorySizeLanguageParser::UNSIGNED_INTEGER, 0);
}
...
MemorySizeLanguageParser::MemoryUnitSizeContext* MemorySizeLanguageParser::memoryUnitSize() {
  MemoryUnitSizeContext *_localctx = _tracker.createInstance<MemoryUnitSizeContext>(_ctx, getState());
...
#else
  ::antlr4::internal::call_once(memorysizelanguageParserOnceFlag, memorysizelanguageParserInitialize);
#endif
}
