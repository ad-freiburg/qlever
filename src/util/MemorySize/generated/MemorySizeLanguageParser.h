...
public:
  ...
  enum {
    RuleMemorySizeString = 0, RulePureByteSize = 1, RuleMemoryUnitSize = 2
  };

  explicit MemorySizeLanguageParser(antlr4::TokenStream *input);

  MemorySizeLanguageParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);
  ...
  public:
    MemorySizeStringContext(antlr4::ParserRuleContext *parent, size_t invokingState);
  ...
  public:
    MemoryUnitSizeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
