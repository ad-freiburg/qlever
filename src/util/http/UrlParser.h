...
struct Query {
  ...
  QL_DEFINE_EQUALITY_OPERATORS(Query, query_, datasetClauses_)
};
...
struct Update {
  ...
  QL_DEFINE_EQUALITY_OPERATORS(Update, update_, datasetClauses_)
};
...
struct GraphStoreOperation {
  ...
  QL_DEFINE_EQUALITY_OPERATORS(GraphStoreOperation, graph_)
};
...
struct None {
  QL_DEFINE_EQUALITY_OPERATORS(None)
};
