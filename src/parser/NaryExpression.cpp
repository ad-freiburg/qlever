...
ExpressionResult DispatchedBinaryExpression<
  ...
  for (size_t i = 1; i < _children.size(); ++i) {
    result = TaggedFunctionVisitor<CalculationWithSetOfIntervals,
                                   TagAndFunctions...>(
...
template class UnaryExpression<NoCalculationWithSetOfIntervals,
                               EffectiveBooleanValueGetter,
                               decltype(unaryNegate), "!">;
template class UnaryExpression<NoCalculationWithSetOfIntervals,
                               NumericValueGetter, decltype(unaryMinus),
                               "unary-">;
...
template class DispatchedBinaryExpression<
    NoCalculationWithSetOfIntervals, NumericValueGetter,
