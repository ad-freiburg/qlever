...
public:
  ...
  enum {
    ...
    RuleNumericExpression = 92, RuleAdditiveExpression = 93, RuleMultiplicativeExpression = 94, 
    RuleUnaryExpression = 95, RulePrimaryExpression = 96, RuleBrackettedExpression = 97, 
    RuleBuiltInCall = 98, RuleRegexExpression = 99, RuleSubstringExpression = 100, 
    RuleStrReplaceExpression = 101, RuleExistsFunc = 102, RuleNotExistsFunc = 103, 
    RuleAggregate = 104, RuleIriOrFunction = 105, RuleRdfLiteral = 106, 
    ...
    RuleIri = 113, RulePrefixedName = 114, RuleBlankNode = 115
  };
