...
class SparqlParser : public antlr4::Parser {
 public:
  ...
  enum {
    ...
    RuleMultiplicativeExpression = 94,
    RuleUnaryExpression = 95,
    RulePrimaryExpression = 96,
    RuleBrackettedExpression = 97,
    RuleBuiltInCall = 98,
    RuleRegexExpression = 99,
    RuleSubstringExpression = 100,
    RuleStrReplaceExpression = 101,
    RuleExistsFunc = 102,
    RuleNotExistsFunc = 103,
    RuleAggregate = 104,
    RuleIriOrFunction = 105,
    RuleRdfLiteral = 106,
    RuleNumericLiteral = 107,
    RuleNumericLiteralUnsigned = 108,
    RuleNumericLiteralPositive = 109,
    RuleNumericLiteralNegative = 110,
    RuleBooleanLiteral = 111,
    RuleString = 112,
    RuleIri = 113,
    RulePrefixedName = 114,
    RuleBlankNode = 115,
    RuleIriref = 116,
    RulePnameLn = 117,
    RulePnameNs = 118
