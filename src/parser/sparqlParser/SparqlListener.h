...
class SparqlListener : public antlr4::tree::ParseTreeListener {
 public:
  ...
  virtual void enterConstructQuery(
      SparqlParser::ConstructQueryContext* ctx) = 0;
  ...
  virtual void enterSolutionModifier(
      SparqlParser::SolutionModifierContext* ctx) = 0;
  ...
  virtual void enterGroupCondition(
      SparqlParser::GroupConditionContext* ctx) = 0;
  ...
  virtual void enterHavingCondition(
      SparqlParser::HavingConditionContext* ctx) = 0;
  ...
  virtual void enterPropertyListNotEmpty(
      SparqlParser::PropertyListNotEmptyContext* ctx) = 0;
  ...
  virtual void enterVerbPathOrSimple(
      SparqlParser::VerbPathOrSimpleContext* ctx) = 0;
  virtual void exitVerbPathOrSimple(
      SparqlParser::VerbPathOrSimpleContext* ctx) = 0;

  virtual void enterObjectListPath(
      SparqlParser::ObjectListPathContext* ctx) = 0;
  ...
  virtual void enterPathAlternative(
      SparqlParser::PathAlternativeContext* ctx) = 0;
  ...
  virtual void enterPathEltOrInverse(
      SparqlParser::PathEltOrInverseContext* ctx) = 0;
  ...
  virtual void enterPathNegatedPropertySet(
      SparqlParser::PathNegatedPropertySetContext* ctx) = 0;
  virtual void exitPathNegatedPropertySet(
      SparqlParser::PathNegatedPropertySetContext* ctx) = 0;

  virtual void enterPathOneInPropertySet(
      SparqlParser::PathOneInPropertySetContext* ctx) = 0;
  ...
  virtual void enterCollectionPath(
      SparqlParser::CollectionPathContext* ctx) = 0;
  ...
  virtual void enterConditionalOrExpression(
      SparqlParser::ConditionalOrExpressionContext* ctx) = 0;
  virtual void exitConditionalOrExpression(
      SparqlParser::ConditionalOrExpressionContext* ctx) = 0;

  virtual void enterConditionalAndExpression(
      SparqlParser::ConditionalAndExpressionContext* ctx) = 0;
