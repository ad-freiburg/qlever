...
class SparqlVisitor : public antlr4::tree::AbstractParseTreeVisitor {
 public:
  ...
  virtual antlrcpp::Any visitSubSelect(
      SparqlParser::SubSelectContext* context) = 0;

  virtual antlrcpp::Any visitSelectClause(
      SparqlParser::SelectClauseContext* context) = 0;
  ...
  virtual antlrcpp::Any visitGroupCondition(
      SparqlParser::GroupConditionContext* context) = 0;
  ...
  virtual antlrcpp::Any visitHavingCondition(
      SparqlParser::HavingConditionContext* context) = 0;
  ...
  virtual antlrcpp::Any visitValuesClause(
      SparqlParser::ValuesClauseContext* context) = 0;

  virtual antlrcpp::Any visitTriplesTemplate(
      SparqlParser::TriplesTemplateContext* context) = 0;
  ...
  virtual antlrcpp::Any visitGroupGraphPatternSub(
      SparqlParser::GroupGraphPatternSubContext* context) = 0;
  ...
  virtual antlrcpp::Any visitServiceGraphPattern(
      SparqlParser::ServiceGraphPatternContext* context) = 0;

  virtual antlrcpp::Any visitBind(SparqlParser::BindContext* context) = 0;

  virtual antlrcpp::Any visitInlineData(
      SparqlParser::InlineDataContext* context) = 0;

  virtual antlrcpp::Any visitDataBlock(
      SparqlParser::DataBlockContext* context) = 0;

  virtual antlrcpp::Any visitInlineDataOneVar(
      SparqlParser::InlineDataOneVarContext* context) = 0;

  virtual antlrcpp::Any visitInlineDataFull(
      SparqlParser::InlineDataFullContext* context) = 0;

  virtual antlrcpp::Any visitDataBlockSingle(
      SparqlParser::DataBlockSingleContext* context) = 0;

  virtual antlrcpp::Any visitDataBlockValue(
      SparqlParser::DataBlockValueContext* context) = 0;

  virtual antlrcpp::Any visitMinusGraphPattern(
      SparqlParser::MinusGraphPatternContext* context) = 0;
  ...
  virtual antlrcpp::Any visitExpressionList(
      SparqlParser::ExpressionListContext* context) = 0;
  ...
  virtual antlrcpp::Any visitBuiltInCall(
      SparqlParser::BuiltInCallContext* context) = 0;
  ...
  virtual antlrcpp::Any visitSubstringExpression(
      SparqlParser::SubstringExpressionContext* context) = 0;

  virtual antlrcpp::Any visitStrReplaceExpression(
      SparqlParser::StrReplaceExpressionContext* context) = 0;

  virtual antlrcpp::Any visitExistsFunc(
      SparqlParser::ExistsFuncContext* context) = 0;

  virtual antlrcpp::Any visitNotExistsFunc(
      SparqlParser::NotExistsFuncContext* context) = 0;

  virtual antlrcpp::Any visitAggregate(
      SparqlParser::AggregateContext* context) = 0;

  virtual antlrcpp::Any visitIriOrFunction(
      SparqlParser::IriOrFunctionContext* context) = 0;
