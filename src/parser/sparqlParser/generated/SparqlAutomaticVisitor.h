...
public:
   ...
   */
    ...
    virtual std::any visitMinMax(SparqlAutomaticParser::MinMaxContext *context) = 0;
    ...
    virtual std::any visitStepsExact(SparqlAutomaticParser::StepsExactContext *context) = 0;
