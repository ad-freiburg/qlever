...
public:
  ...
  virtual void enterExactLength(SparqlAutomaticParser::ExactLengthContext * /*ctx*/) override { }
  virtual void exitExactLength(SparqlAutomaticParser::ExactLengthContext * /*ctx*/) override { }

  virtual void enterOnlyMin(SparqlAutomaticParser::OnlyMinContext * /*ctx*/) override { }
  virtual void exitOnlyMin(SparqlAutomaticParser::OnlyMinContext * /*ctx*/) override { }

  virtual void enterMinMax(SparqlAutomaticParser::MinMaxContext * /*ctx*/) override { }
  virtual void exitMinMax(SparqlAutomaticParser::MinMaxContext * /*ctx*/) override { }

  virtual void enterOnlyMax(SparqlAutomaticParser::OnlyMaxContext * /*ctx*/) override { }
  virtual void exitOnlyMax(SparqlAutomaticParser::OnlyMaxContext * /*ctx*/) override { }

  virtual void enterStepsExact(SparqlAutomaticParser::StepsExactContext * /*ctx*/) override { }
  virtual void exitStepsExact(SparqlAutomaticParser::StepsExactContext * /*ctx*/) override { }
