...
public:
  ...
  enum {
    ...
    RuleLimitClause = 24, RuleOffsetClause = 25, RuleValuesClause = 26, 
    RuleTriplesTemplate = 27, RuleGroupGraphPattern = 28, RuleGroupGraphPatternSub = 29, 
    ...
    RuleInlineDataFull = 39, RuleDataBlockSingle = 40, RuleDataBlockValue = 41, 
    RuleMinusGraphPattern = 42, RuleGroupOrUnionGraphPattern = 43, RuleFilterR = 44, 
    ...
    RuleObjectList = 55, RuleObjectR = 56, RuleTriplesSameSubjectPath = 57, 
    RulePropertyListPath = 58, RulePropertyListPathNotEmpty = 59, RuleVerbPath = 60, 
    RuleVerbSimple = 61, RuleVerbPathOrSimple = 62, RuleObjectListPath = 63, 
    RuleObjectPath = 64, RulePath = 65, RulePathAlternative = 66, RulePathSequence = 67, 
    RulePathElt = 68, RulePathEltOrInverse = 69, RulePathMod = 70, RulePathPrimary = 71, 
    RulePathNegatedPropertySet = 72, RulePathOneInPropertySet = 73, RuleInteger = 74, 
    RuleTriplesNode = 75, RuleBlankNodePropertyList = 76, RuleTriplesNodePath = 77, 
    RuleBlankNodePropertyListPath = 78, RuleCollection = 79, RuleCollectionPath = 80, 
    RuleGraphNode = 81, RuleGraphNodePath = 82, RuleVarOrTerm = 83, RuleVarOrIri = 84, 
    RuleVar = 85, RuleGraphTerm = 86, RuleExpression = 87, RuleConditionalOrExpression = 88, 
    RuleConditionalAndExpression = 89, RuleValueLogical = 90, RuleRelationalExpression = 91, 
    RuleNumericExpression = 92, RuleAdditiveExpression = 93, RuleStrangeMultiplicativeSubexprOfAdditive = 94, 
    RuleMultiplicativeExpression = 95, RuleUnaryExpression = 96, RulePrimaryExpression = 97, 
    RuleBrackettedExpression = 98, RuleBuiltInCall = 99, RuleRegexExpression = 100, 
    RuleSubstringExpression = 101, RuleStrReplaceExpression = 102, RuleExistsFunc = 103, 
    RuleNotExistsFunc = 104, RuleAggregate = 105, RuleIriOrFunction = 106, 
    RuleRdfLiteral = 107, RuleNumericLiteral = 108, RuleNumericLiteralUnsigned = 109, 
    RuleNumericLiteralPositive = 110, RuleNumericLiteralNegative = 111, 
    RuleBooleanLiteral = 112, RuleString = 113, RuleIri = 114, RulePrefixedName = 115, 
    RuleBlankNode = 116, RuleIriref = 117, RulePnameLn = 118, RulePnameNs = 119
  };
