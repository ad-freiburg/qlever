...
class SparqlAutomaticParser : public antlr4::Parser {
 public:
  ...
  enum {
    ...
    RuleGroupClause = 17,
    RuleGroupCondition = 18,
    RuleHavingClause = 19,
    RuleHavingCondition = 20,
    RuleOrderClause = 21,
    RuleOrderCondition = 22,
    RuleLimitOffsetClauses = 23,
    RuleLimitClause = 24,
    RuleOffsetClause = 25,
    RuleValuesClause = 26,
    RuleTriplesTemplate = 27,
    RuleGroupGraphPattern = 28,
    RuleGroupGraphPatternSub = 29,
    RuleTriplesBlock = 30,
    RuleGraphPatternNotTriples = 31,
    RuleOptionalGraphPattern = 32,
    RuleGraphGraphPattern = 33,
    RuleServiceGraphPattern = 34,
    RuleBind = 35,
    RuleInlineData = 36,
    RuleDataBlock = 37,
    RuleInlineDataOneVar = 38,
    RuleInlineDataFull = 39,
    RuleDataBlockSingle = 40,
    RuleDataBlockValue = 41,
    RuleMinusGraphPattern = 42,
    RuleGroupOrUnionGraphPattern = 43,
    RuleFilterR = 44,
    RuleConstraint = 45,
    RuleFunctionCall = 46,
    RuleArgList = 47,
    RuleExpressionList = 48,
    RuleConstructTemplate = 49,
    RuleConstructTriples = 50,
    RuleTriplesSameSubject = 51,
    RulePropertyList = 52,
    RulePropertyListNotEmpty = 53,
    RuleVerb = 54,
    RuleObjectList = 55,
    RuleObjectR = 56,
    RuleTriplesSameSubjectPath = 57,
    RulePropertyListPath = 58,
    RulePropertyListPathNotEmpty = 59,
    RuleVerbPath = 60,
    RuleVerbSimple = 61,
    RuleVerbPathOrSimple = 62,
    RuleObjectListPath = 63,
    RuleObjectPath = 64,
    RulePath = 65,
    RulePathAlternative = 66,
    RulePathSequence = 67,
    RulePathElt = 68,
    RulePathEltOrInverse = 69,
    RulePathMod = 70,
    RulePathPrimary = 71,
    RulePathNegatedPropertySet = 72,
    RulePathOneInPropertySet = 73,
    RuleInteger = 74,
    RuleTriplesNode = 75,
    RuleBlankNodePropertyList = 76,
    RuleTriplesNodePath = 77,
    RuleBlankNodePropertyListPath = 78,
    RuleCollection = 79,
    RuleCollectionPath = 80,
    RuleGraphNode = 81,
    RuleGraphNodePath = 82,
    RuleVarOrTerm = 83,
    RuleVarOrIri = 84,
    RuleVar = 85,
    RuleGraphTerm = 86,
    RuleExpression = 87,
    RuleConditionalOrExpression = 88,
    RuleConditionalAndExpression = 89,
    RuleValueLogical = 90,
    RuleRelationalExpression = 91,
    RuleNumericExpression = 92,
    RuleAdditiveExpression = 93,
    RuleStrangeMultiplicativeSubexprOfAdditive = 94,
    RuleMultiplicativeExpression = 95,
    RuleUnaryExpression = 96,
    RulePrimaryExpression = 97,
    RuleBrackettedExpression = 98,
    RuleBuiltInCall = 99,
    RuleRegexExpression = 100,
    RuleSubstringExpression = 101,
    RuleStrReplaceExpression = 102,
    RuleExistsFunc = 103,
    RuleNotExistsFunc = 104,
    RuleAggregate = 105,
    RuleIriOrFunction = 106,
    RuleRdfLiteral = 107,
    RuleNumericLiteral = 108,
    RuleNumericLiteralUnsigned = 109,
    RuleNumericLiteralPositive = 110,
    RuleNumericLiteralNegative = 111,
    RuleBooleanLiteral = 112,
    RuleString = 113,
    RuleIri = 114,
    RulePrefixedName = 115,
    RuleBlankNode = 116,
    RuleIriref = 117,
    RulePnameLn = 118,
    RulePnameNs = 119
