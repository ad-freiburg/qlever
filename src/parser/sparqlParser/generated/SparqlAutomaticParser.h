...
public:
  ...
  enum {
    ...
    RuleSelectQuery = 4, RuleSubSelect = 5, RuleSelectClause = 6, RuleVarOrAlias = 7, 
    RuleAlias = 8, RuleAliasWithoutBrackets = 9, RuleConstructQuery = 10, 
    RuleDescribeQuery = 11, RuleAskQuery = 12, RuleDatasetClause = 13, RuleDefaultGraphClause = 14, 
    RuleNamedGraphClause = 15, RuleSourceSelector = 16, RuleWhereClause = 17, 
    RuleSolutionModifier = 18, RuleGroupClause = 19, RuleGroupCondition = 20, 
    RuleHavingClause = 21, RuleHavingCondition = 22, RuleOrderClause = 23, 
    RuleOrderCondition = 24, RuleLimitOffsetClauses = 25, RuleLimitClause = 26, 
    RuleOffsetClause = 27, RuleTextLimitClause = 28, RuleValuesClause = 29, 
    RuleUpdate = 30, RuleUpdate1 = 31, RuleLoad = 32, RuleClear = 33, RuleDrop = 34, 
    RuleCreate = 35, RuleAdd = 36, RuleMove = 37, RuleCopy = 38, RuleInsertData = 39, 
    RuleDeleteData = 40, RuleDeleteWhere = 41, RuleModify = 42, RuleDeleteClause = 43, 
    RuleInsertClause = 44, RuleUsingClause = 45, RuleGraphOrDefault = 46, 
    RuleGraphRef = 47, RuleGraphRefAll = 48, RuleQuadPattern = 49, RuleQuadData = 50, 
    RuleQuads = 51, RuleQuadsNotTriples = 52, RuleTriplesTemplate = 53, 
    RuleGroupGraphPattern = 54, RuleGroupGraphPatternSub = 55, RuleGraphPatternNotTriplesAndMaybeTriples = 56, 
    RuleTriplesBlock = 57, RuleGraphPatternNotTriples = 58, RuleOptionalGraphPattern = 59, 
    RuleGraphGraphPattern = 60, RuleServiceGraphPattern = 61, RuleBind = 62, 
    RuleInlineData = 63, RuleDataBlock = 64, RuleInlineDataOneVar = 65, 
    RuleInlineDataFull = 66, RuleDataBlockSingle = 67, RuleDataBlockValue = 68, 
    RuleMinusGraphPattern = 69, RuleGroupOrUnionGraphPattern = 70, RuleFilterR = 71, 
    RuleConstraint = 72, RuleFunctionCall = 73, RuleArgList = 74, RuleExpressionList = 75, 
    RuleConstructTemplate = 76, RuleConstructTriples = 77, RuleTriplesSameSubject = 78, 
    RulePropertyList = 79, RulePropertyListNotEmpty = 80, RuleVerb = 81, 
    RuleObjectList = 82, RuleObjectR = 83, RuleTriplesSameSubjectPath = 84, 
    RulePropertyListPath = 85, RulePropertyListPathNotEmpty = 86, RuleVerbPath = 87, 
    RuleVerbSimple = 88, RuleTupleWithoutPath = 89, RuleTupleWithPath = 90, 
    RuleVerbPathOrSimple = 91, RuleObjectListPath = 92, RuleObjectPath = 93, 
    RulePath = 94, RulePathAlternative = 95, RulePathSequence = 96, RulePathElt = 97, 
    RulePathEltOrInverse = 98, RulePathMod = 99, RuleExactLength = 100, 
    RuleOnlyMin = 101, RuleMinMax = 102, RuleOnlyMax = 103, RuleStepsExact = 104, 
    RuleStepsMin = 105, RuleStepsMax = 106, RulePathPrimary = 107, RulePathNegatedPropertySet = 108, 
    RulePathOneInPropertySet = 109, RuleInteger = 110, RuleTriplesNode = 111, 
    RuleBlankNodePropertyList = 112, RuleTriplesNodePath = 113, RuleBlankNodePropertyListPath = 114, 
    RuleCollection = 115, RuleCollectionPath = 116, RuleGraphNode = 117, 
    RuleGraphNodePath = 118, RuleVarOrTerm = 119, RuleVarOrIri = 120, RuleVar = 121, 
    RuleGraphTerm = 122, RuleExpression = 123, RuleConditionalOrExpression = 124, 
    RuleConditionalAndExpression = 125, RuleValueLogical = 126, RuleRelationalExpression = 127, 
    RuleNumericExpression = 128, RuleAdditiveExpression = 129, RuleMultiplicativeExpressionWithSign = 130, 
    RulePlusSubexpression = 131, RuleMinusSubexpression = 132, RuleMultiplicativeExpressionWithLeadingSignButNoSpace = 133, 
    RuleMultiplicativeExpression = 134, RuleMultiplyOrDivideExpression = 135, 
    RuleMultiplyExpression = 136, RuleDivideExpression = 137, RuleUnaryExpression = 138, 
    RulePrimaryExpression = 139, RuleBrackettedExpression = 140, RuleBuiltInCall = 141, 
    RuleRegexExpression = 142, RuleLangExpression = 143, RuleSubstringExpression = 144, 
    RuleStrReplaceExpression = 145, RuleExistsFunc = 146, RuleNotExistsFunc = 147, 
    RuleAggregate = 148, RuleIriOrFunction = 149, RuleRdfLiteral = 150, 
    RuleNumericLiteral = 151, RuleNumericLiteralUnsigned = 152, RuleNumericLiteralPositive = 153, 
    RuleNumericLiteralNegative = 154, RuleBooleanLiteral = 155, RuleString = 156, 
    RuleIri = 157, RulePrefixedName = 158, RuleBlankNode = 159, RuleIriref = 160, 
    RulePnameLn = 161, RulePnameNs = 162
  };
