...
public:
  enum {
    ...
    OFFSET = 51, TEXTLIMIT = 52, VALUES = 53, LOAD = 54, SILENT = 55, CLEAR = 56, 
    DROP = 57, CREATE = 58, ADD = 59, DATA = 60, MOVE = 61, COPY = 62, INSERT = 63, 
    DELETE = 64, WITH = 65, USING = 66, DEFAULT = 67, GRAPH = 68, ALL = 69, 
    OPTIONAL = 70, SERVICE = 71, BIND = 72, UNDEF = 73, MINUS = 74, UNION = 75, 
    FILTER = 76, NOT = 77, IN = 78, STR = 79, LANG = 80, LANGMATCHES = 81, 
    DATATYPE = 82, BOUND = 83, IRI = 84, URI = 85, BNODE = 86, RAND = 87, 
    ABS = 88, CEIL = 89, FLOOR = 90, ROUND = 91, CONCAT = 92, STRLEN = 93, 
    UCASE = 94, LCASE = 95, ENCODE = 96, FOR = 97, CONTAINS = 98, STRSTARTS = 99, 
    STRENDS = 100, STRBEFORE = 101, STRAFTER = 102, YEAR = 103, MONTH = 104, 
    DAY = 105, HOURS = 106, MINUTES = 107, SECONDS = 108, TIMEZONE = 109, 
  ...
  enum {
    ...
    RuleOffsetClause = 26, RuleTextLimitClause = 27, RuleValuesClause = 28, 
    RuleTriplesTemplate = 29, RuleGroupGraphPattern = 30, RuleGroupGraphPatternSub = 31, 
    RuleTriplesBlock = 32, RuleGraphPatternNotTriples = 33, RuleOptionalGraphPattern = 34, 
    RuleGraphGraphPattern = 35, RuleServiceGraphPattern = 36, RuleBind = 37, 
    RuleInlineData = 38, RuleDataBlock = 39, RuleInlineDataOneVar = 40, 
    RuleInlineDataFull = 41, RuleDataBlockSingle = 42, RuleDataBlockValue = 43, 
    RuleMinusGraphPattern = 44, RuleGroupOrUnionGraphPattern = 45, RuleFilterR = 46, 
    RuleConstraint = 47, RuleFunctionCall = 48, RuleArgList = 49, RuleExpressionList = 50, 
    RuleConstructTemplate = 51, RuleConstructTriples = 52, RuleTriplesSameSubject = 53, 
    RulePropertyList = 54, RulePropertyListNotEmpty = 55, RuleVerb = 56, 
    RuleObjectList = 57, RuleObjectR = 58, RuleTriplesSameSubjectPath = 59, 
    RulePropertyListPath = 60, RulePropertyListPathNotEmpty = 61, RuleVerbPath = 62, 
    RuleVerbSimple = 63, RuleVerbPathOrSimple = 64, RuleObjectListPath = 65, 
    RuleObjectPath = 66, RulePath = 67, RulePathAlternative = 68, RulePathSequence = 69, 
    RulePathElt = 70, RulePathEltOrInverse = 71, RulePathMod = 72, RulePathPrimary = 73, 
    RulePathNegatedPropertySet = 74, RulePathOneInPropertySet = 75, RuleInteger = 76, 
    RuleTriplesNode = 77, RuleBlankNodePropertyList = 78, RuleTriplesNodePath = 79, 
    RuleBlankNodePropertyListPath = 80, RuleCollection = 81, RuleCollectionPath = 82, 
    RuleGraphNode = 83, RuleGraphNodePath = 84, RuleVarOrTerm = 85, RuleVarOrIri = 86, 
    RuleVar = 87, RuleGraphTerm = 88, RuleExpression = 89, RuleConditionalOrExpression = 90, 
    RuleConditionalAndExpression = 91, RuleValueLogical = 92, RuleRelationalExpression = 93, 
    RuleNumericExpression = 94, RuleAdditiveExpression = 95, RuleStrangeMultiplicativeSubexprOfAdditive = 96, 
    RuleMultiplicativeExpression = 97, RuleUnaryExpression = 98, RulePrimaryExpression = 99, 
    RuleBrackettedExpression = 100, RuleBuiltInCall = 101, RuleRegexExpression = 102, 
    RuleSubstringExpression = 103, RuleStrReplaceExpression = 104, RuleExistsFunc = 105, 
    RuleNotExistsFunc = 106, RuleAggregate = 107, RuleIriOrFunction = 108, 
    RuleRdfLiteral = 109, RuleNumericLiteral = 110, RuleNumericLiteralUnsigned = 111, 
    RuleNumericLiteralPositive = 112, RuleNumericLiteralNegative = 113, 
    RuleBooleanLiteral = 114, RuleString = 115, RuleIri = 116, RulePrefixedName = 117, 
    RuleBlankNode = 118, RuleIriref = 119, RulePnameLn = 120, RulePnameNs = 121
  };
