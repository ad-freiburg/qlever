...
public:
  enum {
    ...
    PREFIX_LANGTAG = 148, INTEGER = 149, DECIMAL = 150, DOUBLE = 151, INTEGER_POSITIVE = 152, 
    DECIMAL_POSITIVE = 153, DOUBLE_POSITIVE = 154, INTEGER_NEGATIVE = 155, 
    DECIMAL_NEGATIVE = 156, DOUBLE_NEGATIVE = 157, EXPONENT = 158, STRING_LITERAL1 = 159, 
    STRING_LITERAL2 = 160, STRING_LITERAL_LONG1 = 161, STRING_LITERAL_LONG2 = 162, 
    ECHAR = 163, NIL = 164, ANON = 165, PN_CHARS_U = 166, VARNAME = 167, 
    PN_PREFIX = 168, PN_LOCAL = 169, PLX = 170, PERCENT = 171, HEX = 172, 
    PN_LOCAL_ESC = 173, WS = 174, COMMENTS = 175
  };

  enum {
    RuleUnit = 0, RuleQuery = 1, RulePrologue = 2, RuleBaseDecl = 3, RulePrefixDecl = 4, 
    RuleSelectQuery = 5, RuleSubSelect = 6, RuleSelectClause = 7, RuleVarOrAlias = 8, 
    RuleAlias = 9, RuleAliasWithoutBrackets = 10, RuleConstructQuery = 11, 
    ...
    RulePathEltOrInverse = 99, RulePathMod = 100, RulePathPrimary = 101, 
    RulePathNegatedPropertySet = 102, RulePathOneInPropertySet = 103, RuleInteger = 104, 
    RuleTriplesNode = 105, RuleBlankNodePropertyList = 106, RuleTriplesNodePath = 107, 
    RuleBlankNodePropertyListPath = 108, RuleCollection = 109, RuleCollectionPath = 110, 
    RuleGraphNode = 111, RuleGraphNodePath = 112, RuleVarOrTerm = 113, RuleVarOrIri = 114, 
    RuleVar = 115, RuleGraphTerm = 116, RuleExpression = 117, RuleConditionalOrExpression = 118, 
    RuleConditionalAndExpression = 119, RuleValueLogical = 120, RuleRelationalExpression = 121, 
    RuleNumericExpression = 122, RuleAdditiveExpression = 123, RuleMultiplicativeExpressionWithSign = 124, 
    RulePlusSubexpression = 125, RuleMinusSubexpression = 126, RuleMultiplicativeExpressionWithLeadingSignButNoSpace = 127, 
    RuleMultiplicativeExpression = 128, RuleMultiplyOrDivideExpression = 129, 
    RuleMultiplyExpression = 130, RuleDivideExpression = 131, RuleUnaryExpression = 132, 
    RulePrimaryExpression = 133, RuleBrackettedExpression = 134, RuleBuiltInCall = 135, 
    RuleRegexExpression = 136, RuleLangExpression = 137, RuleSubstringExpression = 138, 
    RuleStrReplaceExpression = 139, RuleExistsFunc = 140, RuleNotExistsFunc = 141, 
    RuleAggregate = 142, RuleIriOrFunction = 143, RuleRdfLiteral = 144, 
    RuleNumericLiteral = 145, RuleNumericLiteralUnsigned = 146, RuleNumericLiteralPositive = 147, 
    RuleNumericLiteralNegative = 148, RuleBooleanLiteral = 149, RuleString = 150, 
    RuleIri = 151, RulePrefixedName = 152, RuleBlankNode = 153, RuleIriref = 154, 
    RulePnameLn = 155, RulePnameNs = 156
  };
