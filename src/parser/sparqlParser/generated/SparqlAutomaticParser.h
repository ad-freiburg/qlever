...
public:
  ...
  enum {
    ...
    RuleTriplesTemplate = 30, RuleGroupGraphPattern = 31, RuleGroupGraphPatternSub = 32, 
    RuleGraphPatternNotTriplesAndMaybeTriples = 33, RuleTriplesBlock = 34, 
    RuleGraphPatternNotTriples = 35, RuleOptionalGraphPattern = 36, RuleGraphGraphPattern = 37, 
    RuleServiceGraphPattern = 38, RuleBind = 39, RuleInlineData = 40, RuleDataBlock = 41, 
    RuleInlineDataOneVar = 42, RuleInlineDataFull = 43, RuleDataBlockSingle = 44, 
    RuleDataBlockValue = 45, RuleMinusGraphPattern = 46, RuleGroupOrUnionGraphPattern = 47, 
    RuleFilterR = 48, RuleConstraint = 49, RuleFunctionCall = 50, RuleArgList = 51, 
    RuleExpressionList = 52, RuleConstructTemplate = 53, RuleConstructTriples = 54, 
    RuleTriplesSameSubject = 55, RulePropertyList = 56, RulePropertyListNotEmpty = 57, 
    RuleVerb = 58, RuleObjectList = 59, RuleObjectR = 60, RuleTriplesSameSubjectPath = 61, 
    RulePropertyListPath = 62, RulePropertyListPathNotEmpty = 63, RuleVerbPath = 64, 
    RuleVerbSimple = 65, RuleTupleWithoutPath = 66, RuleTupleWithPath = 67, 
    RuleVerbPathOrSimple = 68, RuleObjectListPath = 69, RuleObjectPath = 70, 
    RulePath = 71, RulePathAlternative = 72, RulePathSequence = 73, RulePathElt = 74, 
    RulePathEltOrInverse = 75, RulePathMod = 76, RulePathPrimary = 77, RulePathNegatedPropertySet = 78, 
    RulePathOneInPropertySet = 79, RuleInteger = 80, RuleTriplesNode = 81, 
    RuleBlankNodePropertyList = 82, RuleTriplesNodePath = 83, RuleBlankNodePropertyListPath = 84, 
    RuleCollection = 85, RuleCollectionPath = 86, RuleGraphNode = 87, RuleGraphNodePath = 88, 
    RuleVarOrTerm = 89, RuleVarOrIri = 90, RuleVar = 91, RuleGraphTerm = 92, 
    ...
    RuleAdditiveExpression = 99, RuleMultiplicativeExpressionWithSign = 100, 
    RulePlusSubexpression = 101, RuleMinusSubexpression = 102, RuleMultiplicativeExpressionWithLeadingSignButNoSpace = 103, 
    RuleMultiplicativeExpression = 104, RuleMultiplyOrDivideExpression = 105, 
    RuleMultiplyExpression = 106, RuleDivideExpression = 107, RuleUnaryExpression = 108, 
    RulePrimaryExpression = 109, RuleBrackettedExpression = 110, RuleBuiltInCall = 111, 
    RuleRegexExpression = 112, RuleLangExpression = 113, RuleSubstringExpression = 114, 
    RuleStrReplaceExpression = 115, RuleExistsFunc = 116, RuleNotExistsFunc = 117, 
    RuleAggregate = 118, RuleIriOrFunction = 119, RuleRdfLiteral = 120, 
    RuleNumericLiteral = 121, RuleNumericLiteralUnsigned = 122, RuleNumericLiteralPositive = 123, 
    RuleNumericLiteralNegative = 124, RuleBooleanLiteral = 125, RuleString = 126, 
    RuleIri = 127, RulePrefixedName = 128, RuleBlankNode = 129, RuleIriref = 130, 
    RulePnameLn = 131, RulePnameNs = 132
  };
