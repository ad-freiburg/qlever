...
public:
  ...
  virtual void enterExactLength(SparqlAutomaticParser::ExactLengthContext *ctx) = 0;
  virtual void exitExactLength(SparqlAutomaticParser::ExactLengthContext *ctx) = 0;
