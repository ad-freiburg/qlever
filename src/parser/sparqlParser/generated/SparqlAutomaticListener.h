...
public:
  ...
  virtual void enterAliasWithouBrackes(SparqlAutomaticParser::AliasWithouBrackesContext *ctx) = 0;
  virtual void exitAliasWithouBrackes(SparqlAutomaticParser::AliasWithouBrackesContext *ctx) = 0;
  ...
  virtual void enterStrangeMultiplicativeSubexprOfAdditive(SparqlAutomaticParser::StrangeMultiplicativeSubexprOfAdditiveContext *ctx) = 0;
  virtual void exitStrangeMultiplicativeSubexprOfAdditive(SparqlAutomaticParser::StrangeMultiplicativeSubexprOfAdditiveContext *ctx) = 0;
