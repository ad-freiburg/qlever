...
public:
  ...
  virtual antlrcpp::Any visitDataBlockSingle(SparqlParser::DataBlockSingleContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitFilterR(SparqlParser::FilterRContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitObjectR(SparqlParser::ObjectRContext *ctx) override {
    return visitChildren(ctx);
  }
