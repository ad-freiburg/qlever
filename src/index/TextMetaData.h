...
class TextMetaData {
 public:
  ...
  size_t getNofNonLiterals() const { return _nofNonLiterals; }

  void setNofNonLiterals(size_t n) { _nofNonLiterals = n; }
 ...
 private:
  ...
  AD_SERIALIZE_FRIEND_FUNCTION(TextMetaData) {
    ...
    serializer | arg._nofNonLiterals;
