...
struct CompressedBlockMetadataNoBlockIndex {
  ...
  struct OffsetAndCompressedSize {
    ...
    QL_DEFINE_EQUALITY_OPERATORS(OffsetAndCompressedSize, offsetInFile_,
                                 compressedSize_)
  };
  ...
  struct PermutedTriple {
    ...
    Id col2Id_;
    Id graphId_;
    QL_DEFINE_THREEWAY_OPERATOR(PermutedTriple, col0Id_, col1Id_, col2Id_,
                                graphId_)
  ...
  QL_DEFINE_EQUALITY_OPERATORS(CompressedBlockMetadataNoBlockIndex,
                               offsetsAndCompressedSize_, numRows_,
...
struct CompressedBlockMetadata : CompressedBlockMetadataNoBlockIndex {
  ...
  // Two of these are equal if all members are equal.
  QL_DEFINE_EQUALITY_OPERATORS(CompressedBlockMetadata, blockIndex_)
...
struct CompressedRelationMetadata {
  ...
  // Two of these are equal if all members are equal.
  QL_DEFINE_EQUALITY_OPERATORS(CompressedRelationMetadata, col0Id_, numRows_,
                               multiplicityCol1_, multiplicityCol2_,
                               offsetInBlock_)
};
