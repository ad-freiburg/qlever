...
constexpr size_t BLOCKSIZE_COMPRESSED_METADATA = 1ul << 16;  // 64 KB.
// constexpr size_t BLOCKSIZE_COMPRESSED_METADATA = 1ul << 17;  // 128 KB.
// constexpr size_t BLOCKSIZE_COMPRESSED_METADATA = 1ul << 13;  // 8 KB.
