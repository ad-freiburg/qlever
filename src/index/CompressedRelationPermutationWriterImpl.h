...
#ifndef QLEVER_SRC_INDEX_COMPRESSEDRELATIONPERMUTATIONWRITER_H_
#define QLEVER_SRC_INDEX_COMPRESSEDRELATIONPERMUTATIONWRITER_H_
...
#endif  // QLEVER_SRC_INDEX_COMPRESSEDRELATIONPERMUTATIONWRITER_H_
