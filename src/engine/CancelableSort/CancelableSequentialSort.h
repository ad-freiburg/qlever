...
struct TimeoutedAlgorithms {
  TimeoutedAlgorithms(ad_utility::TimeoutChecker* checker)
      : _checker{checker} {}

 private:
  ad_utility::TimeoutChecker* _checker;
  static constexpr size_t NoCheckLimit = 100000;
  void checkTimeout() {
    if (_checker->wlock()->isTimeout()) {
      throw std::runtime_error("Timeout exception in within sequential sort");
    }
  }
 ...
 public:
  ...
  _GLIBCXX20_CONSTEXPR void __move_median_to_first(_Iterator __result,
                                                   _Iterator __a, _Iterator __b,
                                                   _Iterator __c,
                                                   _Compare __comp) {
    if (__comp(__a, __b)) {
      if (__comp(__b, __c))
  ...
  _GLIBCXX20_CONSTEXPR _ForwardIterator1
  ...
  template <typename _ForwardIterator1, typename _ForwardIterator2,
            typename _BinaryPredicate>
  _GLIBCXX20_CONSTEXPR _ForwardIterator1 __find_end(_ForwardIterator1 __first1,
  ...
  __find_end(_BidirectionalIterator1 __first1, _BidirectionalIterator1 __last1,
    ...
    __glibcxx_function_requires(
        ...
        __glibcxx_function_requires(
            ...
            typedef std::reverse_iterator<_BidirectionalIterator1>
                _RevIterator1;
   ...
   */
  template <typename _InputIterator, typename _Predicate>
  _GLIBCXX20_CONSTEXPR inline bool all_of(_InputIterator __first,
   ...
   */
  template <typename _InputIterator, typename _Predicate>
  _GLIBCXX20_CONSTEXPR inline bool none_of(_InputIterator __first,
                                           _InputIterator __last,
                                           _Predicate __pred) {
   ...
   */
  template <typename _InputIterator, typename _Predicate>
  _GLIBCXX20_CONSTEXPR inline bool any_of(_InputIterator __first,
                                          _InputIterator __last,
                                          _Predicate __pred) {
   ...
   */
  template <typename _InputIterator, typename _Predicate>
  _GLIBCXX20_CONSTEXPR inline _InputIterator find_if_not(_InputIterator __first,
                                                         _InputIterator __last,
                                                         _Predicate __pred) {
    // concept requirements
   ...
   */
  template <typename _InputIterator, typename _Predicate>
  _GLIBCXX20_CONSTEXPR inline bool is_partitioned(_InputIterator __first,
                                                  _InputIterator __last,
                                                  _Predicate __pred) {
  ...
  _GLIBCXX20_CONSTEXPR _OutputIterator __copy_n_a(_InputIterator __first,
                                                  _Size __n,
                                                  _OutputIterator __result) {
    if (__n > 0) {
      while (true) {
   ...
   */
  template <typename _InputIterator, typename _Size, typename _OutputIterator>
  _GLIBCXX20_CONSTEXPR inline _OutputIterator copy_n(_InputIterator __first,
                                                     _Size __n,
                                                     _OutputIterator __result) {
    // concept requirements
    __glibcxx_function_requires(_InputIteratorConcept<_InputIterator>)
  ...
  _GLIBCXX20_CONSTEXPR std::pair<_OutputIterator1, _OutputIterator2>
  partition_copy(_InputIterator __first, _InputIterator __last,
    ...
    return std::pair<_OutputIterator1, _OutputIterator2>(__out_true,
                                                         __out_false);
  }
#endif  // C++11
  ...
  _GLIBCXX20_CONSTEXPR inline _ForwardIterator remove(_ForwardIterator __first,
                                                      _ForwardIterator __last,
                                                      const _Tp& __value) {
    // concept requirements
    __glibcxx_function_requires(
  ...
  __unique_copy(_InputIterator __first, _InputIterator __last,
    ...
    __glibcxx_function_requires(
        ...
        typename std::iterator_traits<_InputIterator>::value_type __value =
            *__first;
    __decltype(
  ...
  __partition(_BidirectionalIterator __first, _BidirectionalIterator __last,
              _Predicate __pred, std::bidirectional_iterator_tag) {
    while (true) {
      while (true)
        if (__first == __last)
          return __first;
  ...
  _ForwardIterator __stable_partition(_ForwardIterator __first,
    ...
    std::_Temporary_buffer<_ForwardIterator, _ValueType> __buf(
  ...
  _GLIBCXX20_CONSTEXPR void __heap_select(_RandomAccessIterator __first,
  ...
  _GLIBCXX20_CONSTEXPR void __unguarded_linear_insert(
    ...
    typename std::iterator_traits<_RandomAccessIterator>::value_type __val =
   ...
   */
  static constexpr size_t _S_threshold = 16;
  ...
  _GLIBCXX20_CONSTEXPR void __introsort_loop(_RandomAccessIterator __first,
                                             ...
                                             _Size __depth_limit,
                                             _Compare __comp) {
    while (__last - __first > static_cast<int>(_S_threshold)) {
      if (__last - __first > static_cast<int>(NoCheckLimit)) {
        checkTimeout();
      }
      if (__depth_limit == 0) {
  ...
  _GLIBCXX20_CONSTEXPR std::pair<_ForwardIterator, _ForwardIterator>
  __equal_range( _ForwardIterator __first, _ForwardIterator __last, const _Tp&
  __val, _CompareItTp __comp_it_val, _CompareTpIt __comp_val_it) { typedef
   ...
   */
  template <typename _ForwardIterator, typename _Tp>
  _GLIBCXX20_CONSTEXPR inline std::pair<_ForwardIterator, _ForwardIterator>
  ...
  template <typename _InputIterator1, typename _InputIterator2,
            typename _Compare>
  _GLIBCXX20_CONSTEXPR bool __includes(_InputIterator1 __first1,
   ...
   */
  template <typename _InputIterator1, typename _InputIterator2>
  _GLIBCXX20_CONSTEXPR inline bool includes(_InputIterator1 __first1,
                                            _InputIterator1 __last1,
                                            _InputIterator2 __first2,
                                            _InputIterator2 __last2) {
    // concept requirements
  ...
  _GLIBCXX14_CONSTEXPR inline std::pair<const _Tp&, const _Tp&> minmax(
      const _Tp& __a, const _Tp& __b) {
    // concept requirements
    __glibcxx_function_requires(_LessThanComparableConcept<_Tp>)

                return __b < __a
        ? std::pair<const _Tp&, const _Tp&>(__b, __a)
        : std::pair<const _Tp&, const _Tp&>(__a, __b);
  }
  ...
  _GLIBCXX14_CONSTEXPR inline std::pair<const _Tp&, const _Tp&> minmax(
    ...
    return __comp(__b, __a) ? std::pair<const _Tp&, const _Tp&>(__b, __a)
                            : std::pair<const _Tp&, const _Tp&>(__a, __b);
  }

  template <typename _ForwardIterator, typename _Compare>
  _GLIBCXX14_CONSTEXPR std::pair<_ForwardIterator, _ForwardIterator>
   ...
   */
  template <typename _ForwardIterator>
  _GLIBCXX14_CONSTEXPR inline std::pair<_ForwardIterator, _ForwardIterator>
  ...
  // N2722 + DR 915.
  template <typename _Tp>
  _GLIBCXX14_CONSTEXPR inline _Tp min(std::initializer_list<_Tp> __l) {
  ...
  template <typename _Tp>
  _GLIBCXX14_CONSTEXPR inline _Tp max(std::initializer_list<_Tp> __l) {
  ...
  template <typename _Tp>
  _GLIBCXX14_CONSTEXPR inline std::pair<_Tp, _Tp> minmax(
      std::initializer_list<_Tp> __l) {
    std::pair<const _Tp*, const _Tp*> __p =
  ...
  template <typename _Tp, typename _Compare>
  _GLIBCXX14_CONSTEXPR inline std::pair<_Tp, _Tp> minmax(
      std::initializer_list<_Tp> __l, _Compare __comp) {
    std::pair<const _Tp*, const _Tp*> __p =
  ...
  template <typename _ForwardIterator1, typename _ForwardIterator2,
            typename _BinaryPredicate>
  _GLIBCXX20_CONSTEXPR bool __is_permutation(_ForwardIterator1 __first1,
                                             _ForwardIterator1 __last1,
                                             _ForwardIterator2 __first2,
                                             _ForwardIterator2 __last2,
                                             _BinaryPredicate __pred) {
    ...
    using _It1_is_RA = std::is_same<_Cat1, std::random_access_iterator_tag>;
    using _It2_is_RA = std::is_same<_Cat2, std::random_access_iterator_tag>;
...
#define __cpp_lib_clamp 201603
  ...
  std::pair<_IntType, _IntType> __gen_two_uniform_ints(
  ...
  void shuffle(_RandomAccessIterator __first, _RandomAccessIterator __last,
    ...
    typedef typename std::remove_reference<_UniformRandomNumberGenerator>::type
        _Gen;
    typedef
        typename std::common_type<typename _Gen::result_type, __ud_type>::type
            __uc_type;
  ...
  _GLIBCXX20_CONSTEXPR inline _InputIterator find(_InputIterator __first,
                                                  _InputIterator __last,
                                                  const _Tp& __val) {
    // concept requirements
    __glibcxx_function_requires(_InputIteratorConcept<_InputIterator>)
   ...
   */
  template <typename _InputIterator, typename _Predicate>
  _GLIBCXX20_CONSTEXPR inline _InputIterator find_if(_InputIterator __first,
                                                     _InputIterator __last,
                                                     _Predicate __pred) {
    // concept requirements
    __glibcxx_function_requires(_InputIteratorConcept<_InputIterator>)
   ...
   */
  template <typename _InputIterator, typename _ForwardIterator>
  _GLIBCXX20_CONSTEXPR _InputIterator find_first_of(_InputIterator __first1,
   ...
   */
  template <typename _ForwardIterator, typename _Tp>
  _GLIBCXX20_CONSTEXPR void replace(_ForwardIterator __first,
                                    _ForwardIterator __last,
  ...
  template <typename _InputIterator1, typename _InputIterator2,
            typename _OutputIterator, typename _Compare>
  _GLIBCXX20_CONSTEXPR _OutputIterator __merge(_InputIterator1 __first1,
                                               _InputIterator1 __last1,
                                               _InputIterator2 __first2,
                                               _InputIterator2 __last2,
                                               _OutputIterator __result,
  ...
  _GLIBCXX20_CONSTEXPR inline _OutputIterator merge(_InputIterator1 __first1,
                                                    _InputIterator1 __last1,
                                                    _InputIterator2 __first2,
                                                    _InputIterator2 __last2,
                                                    _OutputIterator __result) {
  ...
  template <typename _InputIterator1, typename _InputIterator2,
            typename _OutputIterator, typename _Compare>
  _GLIBCXX20_CONSTEXPR _OutputIterator __set_union(_InputIterator1 __first1,
                                                   _InputIterator1 __last1,
                                                   _InputIterator2 __first2,
                                                   _InputIterator2 __last2,
                                                   _OutputIterator __result,
  ...
  _RandomAccessIterator __sample(_InputIterator __first, _InputIterator __last,
                                 ...
                                 std::random_access_iterator_tag, _Size __n,
  ...
  _OutputIterator __sample(_ForwardIterator __first, _ForwardIterator __last,
                           std::forward_iterator_tag, _OutputIterator __out,
                           _Cat, _Size __n, _UniformRandomBitGenerator&& __g) {
    using __distrib_type = std::uniform_int_distribution<_Size>;
    using __param_type = typename __distrib_type::param_type;
    using _USize = std::make_unsigned_t<_Size>;
    using _Gen = std::remove_reference_t<_UniformRandomBitGenerator>;
    using __uc_type = std::common_type_t<typename _Gen::result_type, _USize>;
    ...
    // wrapping issues.
    {
      while (__n != 0 && __unsampled_sz >= 2) {
        const std::pair<_Size, _Size> __p =
...
#define __cpp_lib_sample 201603
  ...
  _SampleIterator sample(_PopulationIterator __first,
    ...
    static_assert(
        std::__or_<std::is_convertible<__pop_cat, std::forward_iterator_tag>,
                   std::is_convertible<__samp_cat,
                                       std::random_access_iterator_tag>>::value,
        "output range must use a RandomAccessIterator when input range"
        " does not meet the ForwardIterator requirements");

    static_assert(std::is_integral<_Distance>::value,
                  "sample size must be an integer type");

    typename std::iterator_traits<_PopulationIterator>::difference_type __d =
        __n;
...
#endif  // QLEVER_CANCELABLESEQUENTIALSORT_H
