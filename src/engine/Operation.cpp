...
void Operation::signalQueryUpdate(bool forceTransmission) const {
  if (_executionContext && _executionContext->areWebsocketUpdatesEnabled()) {
    _executionContext->signalQueryUpdate(*_rootRuntimeInfo, forceTransmission);
  }
}
