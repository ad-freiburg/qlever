...
struct EvaluationContext {
  ...
  // If the expression is part of a GROUP BY then this member has to be set to the
  // variables by which the input is grouped. These variables will then be treated
  // as constants.
