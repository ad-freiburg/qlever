...
INSTANTIATE_NARY(1, FV<NumericIdWrapper<decltype(ad_utility::wktLongitude)>, StringValueGetter>);
INSTANTIATE_NARY(1, FV<NumericIdWrapper<decltype(ad_utility::wktLatitude)>, StringValueGetter>);
INSTANTIATE_NARY(2, FV<NumericIdWrapper<decltype(ad_utility::wktDist)>, StringValueGetter>);
