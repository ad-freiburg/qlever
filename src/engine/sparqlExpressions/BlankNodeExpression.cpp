...
class BlankNodeExpression : public SparqlExpression {
  // Store a unique identifier generated by the parser, or a child expression
  // generating an identifier for this expression.
 ...
 public:
  ...
  CPP_template_2(typename Printable, typename Func)(
      requires ad_utility::InvocableWithConvertibleReturnType<
          Func, const std::optional<Printable>&>
  ...
  ExpressionResult evaluate(EvaluationContext* context) const override {
    if (std::holds_alternative<size_t>(label_)) {
      return evaluateImpl<size_t>(
          context,
          [label = std::optional{std::get<size_t>(
               label_)}]() -> const std::optional<size_t>& { return label; });
    }
