...
class QueryExecutionContext {
 public:
  ...
  // Updates the `LocatedTriplesSnapshot` of the `QueryExecutionContext`. The
  // new snapshot will be used for evaluating queries after this call.
  //
  ...
  void updateLocatedTriplesSnapshot(SharedLocatedTriplesSnapshot newSnapshot) {
    sharedLocatedTriplesSnapshot_ = newSnapshot;
  }
