...
class Qlever {
 ...
 public:
  ...
  // Delete the materialized view with the given name: unload it if loaded,
  // delete its files from disk, and remove it from the central registry,
  // freeing its ID for reuse. Throws if the view does not exist.
