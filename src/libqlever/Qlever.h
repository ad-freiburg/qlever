...
class Qlever {
 ...
 public:
  ...
  //
  // Returns warnings about constructs in `query` that would prevent
  // query-pattern-based rewriting from using this view (blank nodes, the
  // `[ ... ]` shorthand, or simple `/`/`^`-only property paths).
