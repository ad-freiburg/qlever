...
TEST(BenchmarkConfigurationOptionTest, ConstructorException) {
  ...
  // Names with spaces.
  ASSERT_ANY_THROW(
      ad_benchmark::makeBenchmarkConfigurationOption<bool>("Option 1", ""));
}
...
TEST(BenchmarkConfigurationOptionTest, CreateSetAndTest) {
  ...
  */
  auto otherGettersDontWork =
      []<typename WorkingType>(const ConfigurationOption& option) {
  ...
  auto testCaseWithDefault =
      [&setAndTest, &otherGettersDontWork]<typename Type>(
        ...
        ConfigurationOption option{
            ad_benchmark::makeBenchmarkConfigurationOption<Type>(
...
TEST(BenchmarkConfigurationOptionTest, SetValueWithJson) {
  ...
  */
  auto doTestCase = [&getTestCase]<typename Type>() {
    ConfigurationOption option{
        ad_benchmark::makeBenchmarkConfigurationOption<Type>("t", "")};
...
TEST(BenchmarkConfigurationOptionTest, Visit) {
  ...
  */
  auto testCaseWithDefault = [&createComparisonVisitor, &setAndTest,
    ...
    ConfigurationOption option{
        ad_benchmark::makeBenchmarkConfigurationOption<Type>("With_default", "",
                                                             values.first)};
