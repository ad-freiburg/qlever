...
TEST(HttpServer, RequestBodySizeLimit) {
  ...
  auto expectRequestFails = [&ResponseMetadata, &expectRequestHelper](
    ...
    const ad_utility::MemorySize currentLimit =
        RuntimeParameters().get<RequestBodyLimit>();
  ...
  RuntimeParameters().set<RequestBodyLimit>(50_kB);
  ...
  RuntimeParameters().set<RequestBodyLimit>(1_B);
  ...
  RuntimeParameters().set<RequestBodyLimit>(0_B);
