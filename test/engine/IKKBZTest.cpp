...
TEST(IKKBZ_SANITY, EX1_R1toR7) {
  ...
  auto g = JoinOrdering::JoinTree();

  auto R1 = g.add_relation("R1", 10);
  auto R2 = g.add_relation("R2", 100);
  auto R3 = g.add_relation("R3", 100);
  auto R4 = g.add_relation("R4", 100);
  auto R5 = g.add_relation("R5", 18);
  auto R6 = g.add_relation("R6", 10);
  auto R7 = g.add_relation("R7", 20);
  ...
  auto g_R1 = JoinOrdering::IKKBZ(g, R1);
  auto g_R2 = JoinOrdering::IKKBZ(g, R2);
  auto g_R3 = JoinOrdering::IKKBZ(g, R3);
  auto g_R4 = JoinOrdering::IKKBZ(g, R4);
  auto g_R5 = JoinOrdering::IKKBZ(g, R5);
  auto g_R6 = JoinOrdering::IKKBZ(g, R6);
  auto g_R7 = JoinOrdering::IKKBZ(g, R7);
...
(100) ----------+                            | 1/5
  ...
  auto R1 = g.add_relation("R1", 30);
  auto R2 = g.add_relation("R2", 100);
  auto R3 = g.add_relation("R3", 30);
  auto R4 = g.add_relation("R4", 20);
  auto R5 = g.add_relation("R5", 10);
  auto R6 = g.add_relation("R6", 20);
  auto R7 = g.add_relation("R7", 70);
  auto R8 = g.add_relation("R8", 100);
  auto R9 = g.add_relation("R9", 100);
