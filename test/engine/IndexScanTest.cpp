...
// _____________________________________________________________________________
TEST(IndexScanTest, internalPrefixIsCorrectlyChosen) {
  auto* qec = getQec();
  ...
  for (auto permutation : Permutation::ALL) {
    ...
    EXPECT_EQ(IndexScan::getPermutationForTriple(
                  permutation, index,
                  SparqlTripleSimple{regularIri, regularIri, regularIri})
                  .get(),
              permutationPtr);
    EXPECT_EQ(
        IndexScan::getPermutationForTriple(
            permutation, index,
  ...
  EXPECT_THROW(IndexScan::getPermutationForTriple(
                   OPS, index,
