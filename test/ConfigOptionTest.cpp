...
/*
@brief Call the function with each of the alternatives in `ad_utility::ConfigOption::AvailableTypes`
...
/*
The form of a generic test case, for when a value gets converted to it's string, or json,
representation. Other the other way around.
*/
template <typename T>
