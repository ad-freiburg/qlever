...
TEST(FTSAlgorithmsTest, filterByRangeTest) {
  ...
  // None
  blockCids.push_back(V(0));
  blockWids.push_back(V(2));
  ...
  // Match
  blockCids.push_back(V(0));
  blockCids.push_back(V(1));
  blockCids.push_back(V(2));
  blockCids.push_back(V(3));

  blockWids.push_back(V(5));
  blockWids.push_back(V(7));
  blockWids.push_back(V(5));
  blockWids.push_back(V(6));
  ...
  blockCids.push_back(V(4));
  blockWids.push_back(V(8));
  blockScores.push_back(1);
...
TEST(FTSAlgorithmsTest, intersectTest) {
  ...
  matchingContexts.push_back(V(0));
  matchingContexts.push_back(V(2));
  matchingContexts.push_back(V(3));
  ...
  eBlockCids.push_back(V(1));
  eBlockCids.push_back(V(2));
  eBlockCids.push_back(V(2));
  eBlockCids.push_back(V(4));
...
TEST(FTSAlgorithmsTest, intersectKWayTest) {
  ...
  ASSERT_EQ(2u, resScores.size());
  ASSERT_EQ(V(10), resCids[0]);
  ASSERT_EQ(V(10), resCids[1]);
...
TEST(FTSAlgorithmsTest, aggScoresAndTakeTopKContextsTest) {
  try {
    ...
    ASSERT_EQ(V(2u), result(0, 0));
    ASSERT_EQ(V(0u), result(0, 2));
    ASSERT_EQ(V(3u), result(0, 1));
    ASSERT_EQ(V(1u), result(1, 0));
    ASSERT_EQ(V(0u), result(1, 2));
    ASSERT_EQ(V(3u), result(1, 1));
...
TEST(FTSAlgorithmsTest, aggScoresAndTakeTopContextTest) {
  ...
  ASSERT_EQ(V(4u), result(0, 0));
  ASSERT_EQ(V(4u), result(0, 1));
  ASSERT_EQ(V(0u), result(0, 2));
  ASSERT_EQ(V(3u), result(1, 0));
  ASSERT_EQ(V(1u), result(1, 1));
  ASSERT_EQ(V(1u), result(1, 2));
...
TEST(FTSAlgorithmsTest, appendCrossProductWithSingleOtherTest) {
  ...
  ASSERT_EQ(V(2), res[0][1]);
  ASSERT_EQ(V(1), res[0][2]);
  ASSERT_EQ(V(1), res[0][3]);
  ASSERT_EQ(V(1), res[1][0]);
  ASSERT_EQ(V(2), res[1][1]);
  ASSERT_EQ(V(1), res[1][2]);
  ...
  ASSERT_EQ(V(2), res[2][1]);
  ASSERT_EQ(V(1), res[2][2]);
...
TEST(FTSAlgorithmsTest, multVarsAggScoresAndTakeTopKContexts) {
  ...
  ASSERT_EQ(V(3), resW4(0, 1));
  ASSERT_EQ(V(0), resW4(0, 0));
  ASSERT_EQ(V(0), resW4(0, 2));
  ASSERT_EQ(V(0), resW4(0, 3));
  ASSERT_EQ(V(2), resW4(1, 1));
  ASSERT_EQ(V(2), resW4(2, 1));
  ASSERT_EQ(V(2), resW4(3, 1));
  ASSERT_EQ(V(1), resW4(4, 1));
  ASSERT_EQ(V(1), resW4(5, 1));
  k = 2;
  resW4.clear();
  CALL_FIXED_SIZE_1(width, FTSAlgorithms::multVarsAggScoresAndTakeTopKContexts,
                    cids, eids, scores, nofVars, k, &resW4);
  ...
  ASSERT_EQ(V(0), resW4(0, 2));
  ASSERT_EQ(V(0), resW4(0, 3));
  ASSERT_EQ(V(1), resW4(1, 0));
  ASSERT_EQ(V(3), resW4(1, 1));
...
TEST(FTSAlgorithmsTest, oneVarFilterAggScoresAndTakeTopKContexts) {
  ...
  auto [it, success] = fMap1.emplace(V(1), IdTable{1, allocator()});
  ASSERT_TRUE(success);
  ...
  {
    auto [it, suc] = fMap1.emplace(V(0), IdTable{1, allocator()});
    ASSERT_TRUE(suc);
  ...
  {
    auto [it, suc] = fMap4.emplace(V(0), IdTable{4, allocator()});
    ASSERT_TRUE(suc);
    auto& el = it->second;
  ...
  {
    auto [it, suc] = fMap4.emplace(V(2), IdTable(4, allocator()));
    ASSERT_TRUE(suc);
...
TEST(FTSAlgorithmsTest, multVarsFilterAggScoresAndTakeTopKContexts) {
  try {
    ...
    auto [it, suc] = fMap1.emplace(V(1), IdTable{1, allocator()});
    it->second.push_back({V(1)});
    ...
    ASSERT_EQ(V(1), resW4(0, 0));
    ASSERT_EQ(V(2), resW4(0, 1));
    ASSERT_EQ(V(0), resW4(0, 2));
    ...
    ASSERT_EQ(V(2), resW4(2, 0));
    ASSERT_EQ(V(1), resW4(2, 1));
    ...
    ASSERT_EQ(V(1u), resW4(0, 0));
    ASSERT_EQ(V(2u), resW4(0, 1));
    ASSERT_EQ(V(0u), resW4(0, 2));
    ASSERT_EQ(V(1u), resW4(0, 3));
    ASSERT_EQ(V(2u), resW4(1, 0));
    ASSERT_EQ(V(2u), resW4(1, 1));
    ASSERT_EQ(V(0u), resW4(1, 2));
    ASSERT_EQ(V(1u), resW4(1, 3));

    ASSERT_EQ(V(1u), resW4(2, 0));
    ASSERT_EQ(V(2u), resW4(2, 1));
    ASSERT_EQ(V(1u), resW4(2, 2));
    ASSERT_EQ(V(1u), resW4(2, 3));
    ASSERT_EQ(V(2u), resW4(3, 0));
    ASSERT_EQ(V(2u), resW4(3, 1));
    ASSERT_EQ(V(1u), resW4(3, 2));
    ASSERT_EQ(V(1u), resW4(3, 3));

    ASSERT_EQ(V(2u), resW4(4, 0));
    ASSERT_EQ(V(1u), resW4(4, 1));
