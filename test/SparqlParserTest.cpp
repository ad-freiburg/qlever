...
TEST(ParserTest, testParse) {
  try {
    ...
    ASSERT_EQ("?y", pq._rootGraphPattern._whereClauseTriples[0]._o);
    ASSERT_EQ("?y", pq._rootGraphPattern._whereClauseTriples[1]._s);
    ASSERT_EQ("<http://ns/myrel.extend>", pq._rootGraphPattern._whereClauseTriples[1]._p);
    ASSERT_EQ("?z", pq._rootGraphPattern._whereClauseTriples[1]._o);
    ASSERT_EQ("?y", pq._rootGraphPattern._whereClauseTriples[2]._s);
    ASSERT_EQ("nsx:rel2", pq._rootGraphPattern._whereClauseTriples[2]._p);
    ASSERT_EQ("\"Hello... World\"", pq._rootGraphPattern._whereClauseTriples[2]._o);
    ASSERT_EQ("", pq._limit);
    ASSERT_EQ("", pq._offset);
    ...
    ASSERT_EQ(SparqlFilter::FilterType::NE, pq._rootGraphPattern._filters[0]._type);
    ASSERT_EQ("?y", pq._rootGraphPattern._filters[1]._lhs);
    ASSERT_EQ("?x", pq._rootGraphPattern._filters[1]._rhs);
    ASSERT_EQ(SparqlFilter::FilterType::LT, pq._rootGraphPattern._filters[1]._type);
    ...
    ASSERT_EQ(CONTAINS_ENTITY_PREDICATE, pq._rootGraphPattern._whereClauseTriples[2]._p);
    ASSERT_EQ("?x", pq._rootGraphPattern._whereClauseTriples[2]._o);
    ASSERT_EQ("?c", pq._rootGraphPattern._whereClauseTriples[3]._s);
    ASSERT_EQ(CONTAINS_WORD_PREDICATE, pq._rootGraphPattern._whereClauseTriples[3]._p);
...
TEST(ParserTest, testFilterWithoutDot) {
  ...
  ASSERT_EQ("<http://rdf.freebase.com/ns/m.0fkvn>", pq._rootGraphPattern._filters[0]._rhs);
  ASSERT_EQ(SparqlFilter::FilterType::NE, pq._rootGraphPattern._filters[0]._type);
  ASSERT_EQ("?1", pq._rootGraphPattern._filters[1]._lhs);
  ASSERT_EQ("<http://rdf.freebase.com/ns/m.0vmt>", pq._rootGraphPattern._filters[1]._rhs);
  ASSERT_EQ(SparqlFilter::FilterType::NE, pq._rootGraphPattern._filters[1]._type);
  ASSERT_EQ("?1", pq._rootGraphPattern._filters[2]._lhs);
  ASSERT_EQ("<http://rdf.freebase.com/ns/m.018mts>", pq._rootGraphPattern._filters[2]._rhs);
  ASSERT_EQ(SparqlFilter::FilterType::NE, pq._rootGraphPattern._filters[2]._type);
}
...
TEST(ParserTest, testExpandPrefixes) {
  ...
  ASSERT_EQ("?z", pq._selectedVariables[1]);
  ASSERT_EQ("?x", pq._rootGraphPattern._whereClauseTriples[0]._s);
  ASSERT_EQ("<http://rdf.myprefix.com/myrel>", pq._rootGraphPattern._whereClauseTriples[0]._p);
  ASSERT_EQ("?y", pq._rootGraphPattern._whereClauseTriples[0]._o);
  ASSERT_EQ("?y", pq._rootGraphPattern._whereClauseTriples[1]._s);
  ASSERT_EQ("<http://rdf.myprefix.com/ns/myrel>", pq._rootGraphPattern._whereClauseTriples[1]
      ._p);
  ASSERT_EQ("?z", pq._rootGraphPattern._whereClauseTriples[1]._o);
  ASSERT_EQ("?y", pq._rootGraphPattern._whereClauseTriples[2]._s);
  ASSERT_EQ("nsx:rel2", pq._rootGraphPattern._whereClauseTriples[2]._p);
...
TEST(ParserTest, testSolutionModifiers) {
  ...
  ASSERT_EQ("\"00-00-2000\"^^xsd:date", pq._rootGraphPattern._whereClauseTriples[0]._o);
