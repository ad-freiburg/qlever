...
TEST_F(LocatedTriplesTest, locatedTriple) {
  const Permutation::KeyOrder keyOrder{0, 1, 2, 3};
  using LT = LocatedTriple;
...

  {
    ...
    auto locatedTriples = LocatedTriple::locateTriplesInPermutation(
        ...
        Span{CBM(PT1, PT1), CBM(PT2, PT7), CBM(PT8, PT8)}, {0, 1, 2, 3}, false,
        handle);
    EXPECT_THAT(locatedTriples,
                testing::ElementsAreArray(
...

  {
    ...
    auto locatedTriples = LocatedTriple::locateTriplesInPermutation(
        triplesToLocate, Span{CBM(PT1, PT8)}, {0, 1, 2, 3}, false, handle);
    EXPECT_THAT(locatedTriples,
                testing::ElementsAreArray(
