...
void PrintTo(const SortedSequenceTwoSortedRanges<V, Compare, Projection>& s,
             std::ostream* os) {
  *os << '[';
  lazyStrJoin(os,
...
using SV = SortedSequenceTwoSortedRanges<Pair, std::less<>,
...
struct SortedSequenceTwoSortedRangesPairsTestHelper {
...
namespace {
constexpr SortedSequenceTwoSortedRangesPairsTestHelper StateIs{};
}  // namespace

// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, constructor) {
  {
    SV s{};
...
// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, empty) {
...
// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, size) {
  {
    SV s{};
    s.insert(p10);
...
// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, clear) {
  SV s{};
...
// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, insert) {
  SV s{};
...
// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, back) {
  {
    SV s{};
...
// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, front) {
  {
    SV s{};
    testConstOverloads(s, [](auto& s) {
...
// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, consolidate) {
  {
...
// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, iteration) {
...
// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, erase) {
  {
...
// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, sortAndRemoveDuplicates) {
...
// ____________________________________________________________________________
TEST(SortedSequenceTwoSortedRangesTest, eraseSortedSubRange) {
  using Pairs = std::vector<std::pair<int, int>>;
