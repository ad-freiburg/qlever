...
If the `qlever` script does not work for you for whatever reason, have a look at the [Dockerfile for Ubuntu 22.04](https://github.com/ad-freiburg/qlever/blob/master/Dockerfile) or the [Dockerfiles for older Ubuntu versions](https://github.com/ad-freiburg/qlever/tree/master/Dockerfiles). The source code of the [qlever-control repository](https://github.com/ad-freiburg/qlever-control) also provides information on how to use QLever (in particular, note the commands [`start`](https://github.com/ad-freiburg/qlever-control/blob/main/src/qlever/commands/start.py) and [`index`](https://github.com/ad-freiburg/qlever-control/blob/main/src/qlever/commands/index.py).
