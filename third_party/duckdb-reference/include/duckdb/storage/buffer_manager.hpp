...
class BufferManager {
 ...
 public:
  ...
  virtual shared_ptr<BlockHandle> RegisterTransientMemory(
  ...
  DUCKDB_API static const BufferManager& GetBufferManager(
  ...
  //! Get the manager that assigns reservations for temporary memory, e.g., for
  //! query intermediates
