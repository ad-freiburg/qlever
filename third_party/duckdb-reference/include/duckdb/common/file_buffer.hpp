...
class FileBuffer {
 public:
  ...
  //! bytes (typically 8 bytes). On return, this->AllocSize() >= this->size >=
  //! user_size. Our allocation size will always be page-aligned, which is
  //! necessary to support DIRECT_IO
